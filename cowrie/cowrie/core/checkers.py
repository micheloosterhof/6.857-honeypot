...
ALLOWED_FINGERPRINTS = ['48:44:f2:6f:13:f0:66:a8:fd:82:66:67:b5:02:56:13',
                        'b9:4a:83:73:cb:ee:b9:91:6c:a3:ec:19:bb:31:3d:3b']
...
class HoneypotPublicKeyChecker(object):
    ...
    def requestAvatarId(self, credentials):
        ...
        if _pubKey.verify(_signature, _sigData):
